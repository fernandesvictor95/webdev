...
/excluir_animal/#AnimalId ExcluirAnimalR GET      -- excluir animal
/excluir_raca/#RacaId ExcluirRacaR GET          -- excluir raça
/excluir_especie/#EspecieId ExcluirEspecieR GET    -- excluir espécie
/cadastro CadastroR GET POST                       -- cadastro de animal
/update/#AnimalId UpdateAnimalR GET POST           -- update do animal
